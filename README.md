...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-y1fzmhy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-y1fzmhy.containers.anotherwebservice.com/
...
```
git clone git@github.com:enterprisium/container-y1fzmhy.git
cd container-y1fzmhy
```
...
```
docker attach container-y1fzmhy
```
